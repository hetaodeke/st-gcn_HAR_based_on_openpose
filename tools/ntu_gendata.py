...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/media/andy/E2625027624FFF2B/Raw_Skeleton_S01-S17/skeleton+D0-30000')
    parser.add_argument(
        '--ignored_sample_path',
        default='/home/andy/GitHub项目/st-gcn/resource/NTU-RGB-D/samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='/home/andy/GitHub项目/st-gcn_HAR_based_on_openpose/data/NTU-RGB-D')
