...
class Feeder_Stgcn(torch.utils.data.Dataset):
    ...
    def load_data(self):
        # load file list
        self.sample_name = sorted(os.listdir(self.data_path))
    ...
    def __getitem__(self, index):
        ...
        for files in sorted(glob.glob('*.json')):
            with open(files, 'r') as f:
                video_info = json.load(f)

        # fill data_numpy
            frame_info = video_info['camera']['data']
            frame_index = int(frame_info['frame_id'])
